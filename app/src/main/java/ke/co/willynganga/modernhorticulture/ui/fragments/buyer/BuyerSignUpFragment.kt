...
@AndroidEntryPoint
class BuyerSignUpFragment : Fragment(R.layout.fragment_buyer_sign_up) {
    ...
    private fun setupOnClickListeners() {
        binding.goToSignIn.setOnClickListener {
            findNavController().navigate(
                BuyerSignUpFragmentDirections.actionBuyerSignUpFragmentToBuyerSignInFragment()
            )
        }
                ...
                is Resource.Success -> {
                    ...
                    resource.data?.let { msg ->
                        ...
                        Toast.makeText(requireContext(), msg, Toast.LENGTH_SHORT)
                            .show()
                        findNavController().navigate(
                            BuyerSignUpFragmentDirections.actionBuyerSignUpFragmentToBuyerHomeFragment()
                        )
                    }
                }
                is Resource.Error -> {
